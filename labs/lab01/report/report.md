...
У меня уже установлена виртуальная машина с образом Федора потому что я начал выполнять работы позже.

![Рабочая виртуальная машина](image/01.png){ #fig:001 width=70% height=70% }

![Запущенная машина](image/02.png){ #fig:002 width=70% height=70% }

![Терминал](image/03.png){ #fig:003 width=70% height=70% }
...
![Команда dmesg](image/04.png){ #fig:004 width=70% height=70% }

6. Тип файловой системы корневого раздела.
7. Последовательность монтирования файловых систем

![Команда df](image/05.png){ #fig:005 width=70% height=70% }
