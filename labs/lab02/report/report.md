...
Я зарегистрировался в гитхаб когда начал с опозданием сдавать лабораторные работы. Поэтому у меня уже есть профиль и репозиторий.

![Загрузка пакетов](image/01.png){ #fig:001 width=70% height=70% }

![Ключи репозитория](image/02.png){ #fig:002 width=70% height=70% }
